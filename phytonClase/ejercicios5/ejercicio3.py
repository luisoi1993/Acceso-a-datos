...
#Igual que el anterior, sólo que ahora NO se pintan las diagonales
...
# Definir los movimientos adyacentes: arriba, abajo, izquierda, derecha (sin diagonales)
movimientos = [
    (-1, 0), (1, 0), (0, -1), (0, 1)  # Solo movimientos verticales y horizontales
]
