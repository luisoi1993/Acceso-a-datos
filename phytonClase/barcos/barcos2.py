...
#falta que genere los barcos en diagonal
...
def main():
    ...
    while True:
        ...
        if opcion == '1':
            ...
            col = int(input("Introduce fila (1-10) para atacar: ")) - 1  # Resta 1 para convertir a índice de lista
            ...
            col = int(input("Tu compañero, introduce fila (1-10) que atacaste: ")) - 1  # Resta 1 para convertir a índice de lista
            fila_index = letra_a_indice(fila)
